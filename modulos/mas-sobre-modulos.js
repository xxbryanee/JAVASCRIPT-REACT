...
const resultado = funcionSumar(5, 3); // Llamada a la función sumar
...
// En este caso, la función se asigna a una variable y no tiene un nombre específico.
 ...
 function sumar ( n1, n2) { //funcion declarada con parametros
    return n1 + n2; //funcion con retorno
}

 function restar ( n1, n2) { //funcion declarada con parametros
    return n1 - n2; //funcion con retorno
}
